...
const Availability = () => {
    ...
    const availableThisMonth = daysInMonth - unavailableThisMonth;
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                    ...
                    <div className="payment-summary" style={{ display: 'block' }}>
                        <div className="summary-card" style={{ height: '100%' }}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'between', padding: '0.75rem 0', borderBottom: '1px solid #E5E7EB', alignItems: 'center' }}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'between', padding: '0.75rem 0', alignItems: 'center' }}>
